...
const CATEGORIES = [
  ...
  { slug: 'international-schools', name: 'International Schools',     abbr: 'INT', color: 'bg-purple-600' },
  { slug: 'national-schools',      name: 'National Schools',          abbr: 'NAT', color: 'bg-orange-600' },
  { slug: 'private-schools',       name: 'Private Schools',           abbr: 'PVT', color: 'bg-red-700' },
  { slug: 'vocational',            name: 'Vocational & Professional', abbr: 'VOC', color: 'bg-indigo-600' },
]
      ...
      <section className="max-w-7xl mx-auto px-4 py-14">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {CATEGORIES.map(cat => (
            ...
            >
              <div className={`${cat.color} text-white w-14 h-14 rounded-2xl flex items-center justify-center text-sm font-bold`}>
                {cat.abbr}
              </div>
